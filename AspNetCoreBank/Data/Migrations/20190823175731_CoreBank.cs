    ...
    public partial class CoreBank : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2019, 8, 23, 14, 57, 30, 469, DateTimeKind.Local), 95699120, "Umanchuk", "Jury" });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "Date", "Document", "Lastname", "Name" },
                values: new object[] { 2, new DateTime(2019, 8, 23, 14, 57, 30, 470, DateTimeKind.Local), 95598062, "Perez", "Linda" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, null, new DateTime(2019, 8, 23, 14, 57, 30, 471, DateTimeKind.Local), 1, 150m, 1 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "ClientId", "Closing_date", "Opening_date", "ProductTypeId", "current_balance", "status" },
                values: new object[] { 3, 2, null, new DateTime(2019, 8, 23, 14, 57, 30, 471, DateTimeKind.Local), 1, 500m, 1 });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "ClientId", "Closing_date", "Opening_date", "ProductTypeId", "current_balance", "status" },
                values: new object[] { 2, 1, null, new DateTime(2019, 8, 23, 14, 57, 30, 471, DateTimeKind.Local), 2, 100m, 1 });

            migrationBuilder.InsertData(
                table: "Movements",
                columns: new[] { "Id", "MovementsTypeId", "ProductsId", "amount", "date", "status" },
                values: new object[] { 1, 1, 1, 150m, new DateTime(2019, 8, 23, 14, 57, 30, 472, DateTimeKind.Local), 1 });

            migrationBuilder.InsertData(
                table: "Movements",
                columns: new[] { "Id", "MovementsTypeId", "ProductsId", "amount", "date", "status" },
                values: new object[] { 2, 2, 1, 100m, new DateTime(2019, 8, 23, 14, 57, 30, 472, DateTimeKind.Local), 1 });
