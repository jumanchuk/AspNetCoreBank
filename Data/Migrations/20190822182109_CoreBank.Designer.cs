...
namespace AspNetCoreBank.Data.Migrations
{
    ...
    [Migration("20190822182109_CoreBank")]
            ...
            modelBuilder.Entity("AspNetCoreBank.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2019, 8, 22, 15, 21, 9, 35, DateTimeKind.Local), Document = 95699120, Lastname = "Umanchuk", Name = "Jury" },
                        new { Id = 2, Date = new DateTime(2019, 8, 22, 15, 21, 9, 35, DateTimeKind.Local), Document = 95598062, Lastname = "Perez", Name = "Linda" }
                    );
                });
            ...
            modelBuilder.Entity("AspNetCoreBank.Models.Movements", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, MovementsTypeId = 1, ProductId = 1, amount = 150m, date = new DateTime(2019, 8, 22, 15, 21, 9, 35, DateTimeKind.Local), status = 1 },
                        new { Id = 2, MovementsTypeId = 2, ProductId = 1, amount = 100m, date = new DateTime(2019, 8, 22, 15, 21, 9, 35, DateTimeKind.Local), status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("AspNetCoreBank.Models.Products", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ClientId = 1, Opening_date = new DateTime(2019, 8, 22, 15, 21, 9, 35, DateTimeKind.Local), ProductTypeId = 1, current_balance = 150m, status = 1 },
                        new { Id = 2, ClientId = 1, Opening_date = new DateTime(2019, 8, 22, 15, 21, 9, 35, DateTimeKind.Local), ProductTypeId = 2, current_balance = 100m, status = 1 },
                        new { Id = 3, ClientId = 2, Opening_date = new DateTime(2019, 8, 22, 15, 21, 9, 35, DateTimeKind.Local), ProductTypeId = 1, current_balance = 500m, status = 1 }
                    );
                });
